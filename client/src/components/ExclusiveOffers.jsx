...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
      <div className='flex flex-col md:flex-col md:flex-row items-center justify-between w-full'>
        <Title align='left' title="Unveil Luxury Deals" subTitle = "Discover limited-time luxury offers that combine elegance, comfort, and unbeatable value for every traveler."/>
        <button className='group flex items-center gap-2 font-medium cursor-pointer max-md:mt-12'>
            Browse Luxe Packages
