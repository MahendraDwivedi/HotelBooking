  ...
  return room &&  (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <form action="" className='flex flex-col md:flex-row items:start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          <div className='flex flex-col'>
            ...
            <input type="number" id='guests' placeholder='0' className='max-w-20 rounded borer border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
          </div>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Spacious and practical, the Family Room comes with a king bed and two twin beds (or sofa bed), along with extra storage space and child-friendly amenities. Entertainment options and blackout curtains ensure everyone sleeps well.Our Executive Suites offer luxury and functionality. Includes a separate living area, king-size bed, minibar, walk-in closet, and a well-lit workspace. Perfect for travelers who need a blend of relaxation and productivity.</p>
      </div>
...
{/* hosted by */}
      <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
          ...
          <div>
            <p className='text-lg md:textxl'>Hosted by {room.hotel.name}</p>
