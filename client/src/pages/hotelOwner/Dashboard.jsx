...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='font' title='Dashboard' subTitle='Welcome to your dashboard – track progress, manage data, view insights, and stay updated with all your essential information.' />
